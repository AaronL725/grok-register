...
old_marker = 'def add_token_to_grok2api_remote_pool(raw_token, email="", log_callback=None):\n'
new_code = '''def _grok2api_go_api_base(base):
...
'''
replace_once("account_outputs.py", old_marker, new_code)
...
Path("tests/test_grok2api_go_remote.py").write_text(
    '''import unittest
