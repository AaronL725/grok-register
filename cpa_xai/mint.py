...
def mint_and_export(
    ...
    initial_request_timeout_sec=15.0,
    poll_request_timeout_sec=12.0,
    ...
    try:
        tokens = mint_with_browser(
            ...
            initial_request_timeout_sec=float(initial_request_timeout_sec),
            poll_request_timeout_sec=float(poll_request_timeout_sec),
            poll_log=logger,
            cancel=cancel,
